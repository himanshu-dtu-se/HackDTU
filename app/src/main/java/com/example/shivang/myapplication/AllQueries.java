...
public class AllQueries extends Fragment {
    ...
    private AllNewsAdapter newsAdapter1;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONObject obj = jsonObject.getJSONObject("Common");

                            JSONObject item = obj.getJSONObject("20f0f92f386950a25c1c321d3a8f332232e4fa2a");
                            articlesList.add(
                                    new ArticleModel(
                                    ...
                                    "20f0f92f386950a25c1c321d3a8f332232e4fa2a"));
...
*/
                            newsAdapter1 = new AllNewsAdapter(getContext() , articlesList);
